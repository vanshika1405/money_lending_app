...
class AdjustmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adjustment" do
    assert_difference("Adjustment.count") do
      post adjustments_url, params: { adjustment: { amount: @adjustment.amount, interest_rate: @adjustment.interest_rate, loan_id: @adjustment.loan_id } }
    end
  ...
  test "should update adjustment" do
    patch adjustment_url(@adjustment), params: { adjustment: { amount: @adjustment.amount, interest_rate: @adjustment.interest_rate, loan_id: @adjustment.loan_id } }
